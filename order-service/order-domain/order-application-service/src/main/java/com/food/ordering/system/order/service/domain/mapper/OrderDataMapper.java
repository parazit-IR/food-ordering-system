...
public class OrderDataMapper {
    ...
    public List<com.food.ordering.system.order.service.domain.entity.OrderItem> orderItemsToOrderItemEntity(List<OrderItem> orderItems) {
        return orderItems.stream().map(orderItem -> com.food.ordering.system.order.service.domain.entity.OrderItem.builder()
